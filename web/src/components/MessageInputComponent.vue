...
.input-box {
  ...
  background:
    linear-gradient(var(--gray-0), var(--gray-0)) padding-box,
    linear-gradient(90deg, var(--gray-200), var(--gray-200)) border-box;
  gap: 0px;
  position: relative;
  ...
  &:hover {
    background:
      linear-gradient(var(--gray-0), var(--gray-0)) padding-box,
      linear-gradient(90deg, var(--main-color), var(--sub-color)) border-box;
  }
  ...
  &:focus-within {
    background:
      linear-gradient(var(--gray-0), var(--gray-0)) padding-box,
      linear-gradient(90deg, var(--main-color), var(--sub-color)) border-box;
    box-shadow: 0 4px 12px color-mix(in srgb, var(--main-500) 15%, transparent);
  }
}
